...
function FieldWorkers() {
  ...
  const fetch_url = `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/services`
  ...
  return (
    <div>
      <h3 className="text-2xl text-gray-700 dark:text-gray-100 font-bold">Field Worker "Under Development"</h3>
      ...
      <div className="flex flex-row gap-2 min-w-full">
        <div className="min-w-3/4">
          ...
          <Card title="This page manage field-worker" className='my-2'>
            {/* <Link href="/field-worker/create" className="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">Create Project</Link> */}
